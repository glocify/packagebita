...
//echo "<pre>";print_r($data);echo "</pre>";die;
		...
		/*$signp = $this->user->profile;
		$email = $signp->email;
		$identifier = $signp->identifier;
		$session->open();
		$session = Yii::app()->session;
		$session['fbdetails']['email'] = $email; 
		$session['fbdetails']['fbid'] = $identifier; 
		$session->close();*/
		//$fbdetails = serialize($this->user->profile);
		//echo $fbdetails;die;
		$uprf = $this->user->profile;
		$fbdetails = array();
		$fbdetails['email'] = $uprf->email;
		$fbdetails['identifier'] = $uprf->identifier;
		$fbdetails['firstName'] = $uprf->firstName;
		$fbdetails['lastName'] = $uprf->lastName;
		//echo "<pre>";print_r($fbdetails);echo "</pre>";die;
		Yii::app()->session['fbdetails'] = $fbdetails;
		header('Location: https://ads.tripken.com/Site/Signin/');
   
		//echo  Yii::app()->session['email'];die;                
//echo "<pre>";print_r($this->user->profile);echo "</pre>";die;
